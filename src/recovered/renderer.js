...
`);
      a2({ title: `О приложении`, body: `Версия Egoist Shield: ${t3}
Дата сборки: ${n3}

Что нового в ${r3?.[0] ?? t3}:
${i3}

Egoist Shield подтверждает внешний маршрут до показа защищённого состояния, изменяет системные настройки транзакционно и управляет только собственными процессами и службами.`, tone: `info` });
    })();
